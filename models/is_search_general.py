...
class IsSearchGeneral(models.Model):
    ...
    def _ask_vllm_for_model(self):
        ...
        system_prompt = (
            "Tu es un expert Odoo 14. On te donne une demande utilisateur et la liste des modèles Odoo installés. "
    ...
    def _ask_vllm_for_domain(self, model_name):
        ...
        system_prompt = (
            "Tu es un expert Odoo 14. Tu dois générer un domaine Odoo (domain) valide "
    ...
    def _ask_vllm_for_view_type(self):
        ...
        self.ensure_one()
        system_prompt = (
            "Tu es un expert Odoo 14. On te donne une demande utilisateur et tu dois déterminer "
    ...
    def _ask_vllm_for_group_by(self, model_name):
        ...
        fields_desc = self._get_model_fields_description(model_name)
        system_prompt = (
            "Tu es un expert Odoo 14. On te donne une demande utilisateur pour un graphique ou tableau croisé. "
    ...
    def action_save_as_filter(self):
        ...
        self.invalidate_cache(['filter_id'])
